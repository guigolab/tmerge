...
from plugins import Stats, ReadSupport, SplicedLengths, MergedInfo, SpliceSiteScoring, MinLength
...
def main():
    ...
    parser.add_argument("--min_length", help="The minimum length required for output transcripts.", default=200)
