...
C<< tmerge -cpu <number of CPUs> --tmPrefix <string to prepend to output transcript_ids> <input GTF file> > <output file> >>
...
=item B<cpu> (integer) = Number of CPUs to use

Default: 1

=item B<tmPrefix> (string) = Prefix string for transcript_id identifiers in the output
