...
=item * C<exonOverhangTolerance> (integer) = maximum number of nucleotides of exon/intron overhang at a splice site for two transcripts to be considered compatible (i.e., mergeable). See explanation in "DESCRIPTION" below.


B<Default>: 0 (i.e., no exon/intron overhang allowed)
...
=head2 The C<exonOverhangTolerance> option
...
<p><img src="http://public-docs.crg.es/rguigo/CLS/img/tmerge_FalseExonOverhang.300dpi.png" alt="tmerge exonOverhangTolerance sketch" /></p>

=end HTML

This option only affects the terminal exons of a shorter transcript that overlap an intron of a longer one. The setting works as explained below:

=begin HTML

<p><img src="http://public-docs.crg.es/rguigo/CLS/img/tmerge_exonOverhangTolerance_2.png" alt="tmerge exonOverhangTolerance sketch" /></p>
